    ...
    YAHOO.lacuna.Game.QuickDialog(
      {
        width: '500px',
        text: [
          '<p>A client error has occurred. <br>Please report this on <a target="_blank" href="https://github.com/tlecommunity/app/issues">the support forums</a>, and include the data below:</p>',
