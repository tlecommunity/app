    ...
    Alliance.prototype = {
      ...
      _getHtml: function () {
        return [
          ...
          '    <div class="bd">',
          '        <ul>',
          '            <li><label>Name:</label><span id="',
          this.id,
          'Name"></span></li>',
          '            <li><label>Description:</label><span id="',
          this.id,
          'Desc"></span></li>',
          '            <li><label>Founded:</label><span id="',
          this.id,
          'Founded"></span></li>',
          '            <li><label>Leader:</label><span id="',
          this.id,
          'Leader"></span></li>',
          '        </ul>',
          '        <div style="height:200px;overflow:auto;">',
          '            <p style="border-bottom:1px solid #52ACFF;"><label>Members:</label><span id="',
          this.id,
          'MemberCount"></span></p>',
          '            <ul id="',
          this.id,
      ...
      Load: function (allianceId) {
        ...
        Game.Services.Alliance.view_profile(
          { session_id: Game.GetSession(''), alliance_id: allianceId },
          {
            success: function (o) {
              ...
              var memberArray = [
                '<li style="border-bottom:1px solid #52ACFF;"><label>Num</label><label>Name</label></li>',
              ];
              for (var m = 0; m < profile.members.length; m++) {
                ...
                memberArray = memberArray.concat([
                  '<li><label>',
                  m + 1,
                  '</label><a class="profile_link" style="text-decoration:underline;cursor:pointer;" href="#',
                  member.id,
                  '">',
                  member.name,
                  '</a></li>',
    ...
    Empire.prototype = {
        ...
        if (!this.Panel) {
          ...
          this.Panel = new YAHOO.widget.Dialog(this.id, {
            ...
            buttons: [
              {
                text: 'Send Message',
                handler: { fn: this.sendMessage, scope: this },
                isDefault: true,
              },
            ],
            effect: Game.GetContainerEffect(),
          ...
          this.Panel.hideEvent.subscribe(
            function () {
      ...
      _getHtml: function () {
        ...
        return [
          ...
          '                <div>',
          '                    <ul>',
          '                        <li><label>Empire:</label><span id="',
          this.id,
          'Empire"></span></li>',
          '                        <li><label>Status:</label><span id="',
          this.id,
          'Status"></span></li>',
          '                        <li><label>Description:</label><span id="',
          this.id,
          'Desc"></span></li>',
          '                        <li><label>Species:</label><span id="',
          this.id,
          'Species"></span></li>',
          '                        <li><label>Alliance:</label><span id="',
          this.id,
          'Alliance" style="text-decoration:underline;cursor:pointer;"></span></li>',
          '                        <li><label>Colonies:</label><span id="',
          this.id,
          'ColonyCount"></span></li>',
          '                        <li><label>Founded:</label><span id="',
          this.id,
          'Founded"></span></li>',
          '                        <li><label>Last Login:</label><span id="',
          this.id,
          'Login"></span></li>',
          '                </div>',
          '                <div>',
          '                    <ul id="',
          this.id,
          'ColoniesList" style="height:',
          Ht,
          'px;width:425px;overflow:auto;">',
          '                    </ul>',
          '                </div>',
          '                <div>',
          '                    <ul id="',
          this.id,
          'MedalsList" style="height:',
          Ht,
          'px;width:425px;overflow:auto;">',
          '                    </ul>',
          '                </div>',
          ...
          this.id,
          'PlayerName"></span></li>',
          '                        <li><label>City:</label><span id="',
          this.id,
          'City"></span></li>',
          '                        <li><label>Country:</label><span id="',
          this.id,
          'Country"></span></li>',
          '                        <li><label>Skype:</label><span id="',
          this.id,
          'Skype"></span></li>',
          '                    </ul>',
          '                </div>',
      ...
      Load: function (empireId) {
        ...
        Game.Services.Empire.view_public_profile(
          { session_id: Game.GetSession(''), empire_id: empireId },
          {
            success: function (o) {
              MenuStore.hideLoader();
              var profile = o.result.profile;
              ...
              this.skype.innerHTML = profile.skype
                ? ['<a href="callto:', profile.skype, '">', profile.skype, '</a>'].join('')
                : '';

              var medalArray = [];
              for (var medalId in profile.medals) {
                var medal = profile.medals[medalId];
                medalArray = medalArray.concat([
                  '<li class="medal">',
              ...
              for (var colonyId in profile.known_colonies) {
                ...
                colonyArray = colonyArray.concat([
                  '<li>',
