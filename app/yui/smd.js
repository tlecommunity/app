    ...
    var smd = {
      ...
      Buildings: {
        Generic: {
          ...
          services: {
            ...
            upgrade: {
              description:
                'Adds the requested upgrade to the build queue. On success returns the view() method.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
        ...
        Archaeology: {
          ...
          services: {
            search_for_glyph: {
              description:
                'Searches through ore looking for glyphs left behind by the ancient race. Takes 10,000 of one type of ore to search.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
            ...
            get_glyph_summary: {
              description:
                'Returns a list of glyphs that may be traded. Used with the add_trade method.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
            ...
            view_excavators: {
              description:
                'Returns a list of the excavators currently controlled by this ministry.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
        ...
        BlackHoleGenerator: {
          ...
          services: {
            get_actions_for: {
              description:
                'Provides a list of actions that the BHG can do. Use with generate_singularity.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
            ...
            generate_singularity: {
              ...
              parameters: [{ name: 'params', type: 'object', optional: false }],
              returns: { type: 'object' },
            },
            subsidize_cooldown: {
        ...
        Exchanger: {
          ...
          services: {
            ...
            subsidize_recycling: {
              description:
                'Will spend 2 essentia to complete the current recycling job immediately.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
        ...
        Intelligence: {
          ...
          services: {
            ...
            name_spies: {
              ...
              parameters: [{ name: 'options', type: 'object', optional: false }],
              returns: { type: 'object' },
            },
            subsidize_training: {
              description:
                'Will spend 1 essentia per spy to complete the training of all spies immediately.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
        ...
        Network19: {
          ...
          services: {
            ...
            view_news: {
              description:
                'Get the top 100 headlines from your region of space. It also returns a list of RSS feeds that can be used outside the game to see the same news in a given region.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
        ...
        SpacePort: {
          ...
          services: {
            ...
            fetch_spies: {
              description:
                'Sends a specified ship to fetch specified spies from on_body_id, and bring them back to to_body_id. See also prepare_fetch_spies',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'on_body_id', type: 'string', optional: false },
                { name: 'to_body_id', type: 'string', optional: false },
            ...
            send_spies: {
              description:
                'Sends one or more of spies to a planet using a selected ship. See also prepare_send_spies.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'on_body_id', type: 'string', optional: false },
                { name: 'to_body_id', type: 'string', optional: false },
            ...
            get_fleet_for: {
              description:
                'Provides a list of incoming ships and ships that are available to send to a specific target. Use with send_ship_types.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
            ...
            get_ships_for: {
              description:
                'Provides a list of incoming ships and ships that are available to send to a specific target. Use with send_ship.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'from_body_id', type: 'string', optional: false },
                { name: 'target', type: 'object', optional: false },
            ...
            send_ship_types: {
              description:
                'Sends a group of ships to a specified body or star. Use with get_fleet_for.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'body_id', type: 'string', optional: false },
                { name: 'target', type: 'string', optional: false },
            ...
            view_foreign_ships: {
              description:
                'Shows you all the foreign ships that are incoming. However, the list is filtered by the stealth of the ship vs the level of the SpacePort.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
                { name: 'page_number', type: 'number', optional: true },
            ...
            view_ships_travelling: {
              description:
                'Returns a list of the ships that are travelling to or from this planet. NOTE: All inbound/outbound ships are shown regardless of which space port they will eventually land at.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
                { name: 'page_number', type: 'number', optional: true },
        ...
        Trade: {
          ...
          services: {
            ...
            get_plan_summary: {
              description:
                'Returns a list of plans that may be traded. Used with the add_trade method.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
              ],
      ...
      Chat: {
        ...
        services: {
          init_chat: {
            ...
            parameters: [{ name: 'session_id', type: 'string', optional: false }],
            returns: { type: 'object' },
          },
        },
      },
      Empire: {
        ...
        services: {
          ...
          find: {
            description:
              'Find an empire by name. Returns a hash reference containing empire ids and empire names.',
            parameters: [
              { name: 'session_id', type: 'string', optional: false },
              { name: 'name', type: 'string', optional: false },
            ],
          ...
          boost_building: {
            description:
              'Spends 5 essentia, and boosts building queues on all planets for 7 days. If a boost is already underway, calling again will add 7 more days.',
            parameters: [{ name: 'session_id', type: 'string', optional: false }],
            returns: { type: 'object' },
          },
          boost_spy_training: {
            description:
              'Spends 5 essentia, and boosts spy training on all planets for 7 days. If a boost is already underway, calling again will add 7 more days.',
            parameters: [{ name: 'session_id', type: 'string', optional: false }],
            returns: { type: 'object' },
          },
          ...
          redefine_species: {
            description:
              'Allows a user to spend essentia and redefine their species affinities, name, and description. This can only be used after the empire has been founded.',
            parameters: [
              { name: 'session_id', type: 'string', optional: false },
              { name: 'params', type: 'object', optional: false },
            ],
          ...
          view_species_stats: {
            description:
              "Returns a list of the stats associated with an empire's species as it was originally created.",
            parameters: [{ name: 'session_id', type: 'string', optional: false }],
            returns: { type: 'object' },
          },
          get_species_templates: {
            description:
              'Returns a list of species templates that can be used to populate the form for update_species.',
            parameters: [],
            returns: { type: 'object' },
          },
          invite_friend: {
      ...
      Modules: {
        ...
        PoliceStation: {
          ...
          services: {
            view_foreign_ships: {
              description:
                'Shows you all the foreign ships that are incoming. However, the list is filtered by the stealth of the ship vs the level of the PoliceStation.',
              parameters: [
                { name: 'session_id', type: 'string', optional: false },
                { name: 'building_id', type: 'string', optional: false },
                { name: 'page_number', type: 'number', optional: true },
